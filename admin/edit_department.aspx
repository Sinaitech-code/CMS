<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin1_edit_department" Codebehind="edit_department.aspx.cs" %>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">edit department</div>
            </div>
