...
namespace CMS.admin
{
    public partial class admin_manage_client : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlDataAdapter da;
        DataSet ds;
        ...
        private void fillgrid()
        {
            try
            {
                ...
                cn.Open();
                da = new SqlDataAdapter("select Client_Name,Client_Id from mdx_clients", cn);
                ds = new DataSet();
                da.Fill(ds, "mdx_clients");
                if (ds.Tables["mdx_clients"].Rows.Count == 0)
                {
                ...
                else
                {
                    try
                    {
                        GridView1.DataSource = ds.Tables["mdx_clients"];
                        GridView1.DataBind();
                    }
                    catch (Exception ex)
                    {
