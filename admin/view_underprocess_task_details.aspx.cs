...
namespace CMS.admin
{
    public partial class admin_view_underprocess_task_details : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        {
            Response.Redirect("virew_underprocess_tasks.aspx?");
        }
    }
}