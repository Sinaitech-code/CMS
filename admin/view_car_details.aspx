<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_car_details" Codebehind="view_car_details.aspx.cs" %>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td class="grid_content_indent_1"> <asp:Label ID="lblprojname" runat="server" ></asp:Label></td>
                  </tr>
                  <tr>
                    <td class="grid_content_indent_1">toemp name:</td>
                    <td class="grid_content_indent_1"> <asp:Label ID="lbltoemp" runat="server" ></asp:Label></td>
                  </tr>
                  <tr>
                    <td class="grid_content_indent_1">from:</td>
                    <td class="grid_content_indent_1"><asp:Label ID="lblfromemp" runat="server" ></asp:Label></td>
                  </tr>
                  <tr>
                    <td class="grid_content_indent_1">attention:</td>
                    <td class="grid_content_indent_1"><asp:Label ID="lblattention" runat="server" ></asp:Label></td>
                  </tr>
                  <tr>
                    <td class="grid_content_indent_2" >date & time:</td>
                    <td class="grid_content_indent_2" >  <asp:Label ID="lbldate" runat="server" ></asp:Label></td>
                  </tr>
                     <tr>
                    <td class="grid_content_indent_1">description:</td>
                    <td class="grid_content_indent_1"> <asp:Label ID="lbldescription" runat="server" ></asp:Label></td>
                  </tr>
                  <tr>
                    <td class="grid_content_indent_1"> reply:</td>
                    <td class="grid_content_indent_1"> <asp:Label ID="lblreply" runat="server" ></asp:Label></td>
                  </tr>
                 <tr>
