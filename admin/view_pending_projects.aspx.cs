...
namespace CMS.admin
{
    public partial class admin_view_pending_projects : System.Web.UI.Page
    {
        SqlConnection cn;
        SqlDataAdapter da;
        DataSet ds;
        ...
        private void binddata()
        {
            try
            {
                ...
                cn.Open();
                da = new SqlDataAdapter("select level_name,level_id,user_id,status_id,client_name,status_changed_by from mdx_project_levels where status_id='" + 3 + "' ", cn);
                ds = new DataSet();
