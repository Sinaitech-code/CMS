<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin1_manage_department" Codebehind="manage_department.aspx.cs" %>
      ...
      <a href="#" class="navi_head">Projects</a>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
          ...
          <tr>
          <td>
           <asp:GridView ID="GridView1" runat="server"  width="100%" CssClass="grid_content_1" AutoGenerateColumns ="false" AllowPaging="True" OnPageIndexChanging="gridview_pageindex" >
                <Columns >
