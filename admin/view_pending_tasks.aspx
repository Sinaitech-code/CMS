<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_pending_tasks" Codebehind="view_pending_tasks.aspx.cs" %>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view pending tasks</div>
            </div>
          ...
          <td>
            ...
            <asp:HyperLinkField  Text="view" DataNavigateUrlFields ="task_id"  HeaderText="Manage" DataNavigateUrlFormatString ='view_pending_task_details.aspx?task_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
              </Columns>
