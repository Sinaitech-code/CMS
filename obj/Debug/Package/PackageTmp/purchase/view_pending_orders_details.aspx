<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.purchase_view_pending_orders_details" Codebehind="view_pending_orders_details.aspx.cs" %>
...
<head runat="server">
    <title>View pending orders details</title>
    ...
    <div id="left_navi_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view pending order details</div>
            </div>
           ...
           <div id="form">
         <p align ="center" > <asp:Label ID="lblerr_msg" runat="server"  CssClass ="errmsg" Visible ="false"></asp:Label> </p>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td valign="top" class="grid_content_indent_1"  Width ="100%">
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width ="100%" AutoGenerateColumns ="false" CssClass="grid_content_1"  PageSize="2" DataKeyNames="requisition_detail_id"   >
                   <Columns >
                  ...
                  <ItemTemplate>
                  <%--<asp:RadioButtonList ID="RadioButtonList1" runat="server" CssClass="rbtn" DataSource='<%# bindradiobtnlist()%>'  RepeatColumns="3" RepeatDirection="horizontal" DataTextField="status_name" DataValueField="status_id"></asp:RadioButtonList>--%>
                  <asp:RadioButtonList ID="rbtnlist" runat="server" CssClass="rbtn" RepeatColumns="3" RepeatDirection="horizontal" DataTextField="status_name" DataValueField="status_id"></asp:RadioButtonList>
                  </ItemTemplate>
                       <HeaderStyle CssClass="grid_head" />
                   </asp:TemplateField>
                   </Columns>
                   ...
                   <tr>
                      ...
                      <td  align="center">
                        <asp:Button ID="btnsubmit" runat="server" Text="submit"  CssClass="btn" OnClick="btnsubmit_Click"  /></td>
                  </tr>
                </table>
          </div>
        </div>
