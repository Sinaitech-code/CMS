<%@ Page Language="C#" AutoEventWireup="true" Inherits="admin1_add_project_type" Codebehind="add_project_type.aspx.cs" %>
            ...
            <div id="form">
               ...
               <%-- <p>
                  <label>enter project code:</label>
                    <asp:TextBox ID="txtprojcode" runat="server" CssClass="txt_box" ></asp:TextBox>
                  <%-- <input name="textfield" runat="server"  type="text" class="txt_box" id="txtprojcode" /> </p>--%>
                 <p>
