<%@ Page Language="C#" AutoEventWireup="true" Inherits="admin1_edit_department" Codebehind="edit_department.aspx.cs" %>
    ...
    <!-- end #header_bg -->
     ...
     <div id="content_holder">
        ...
        <div id="form_area">
            ...
            <div id="form">
            	 <%--<p><label>enter department code:</label><%-- <input name="textfield" type="text" class="txt_box" id="txtdeptid" runat="server" />--%>
                    <%-- <asp:TextBox ID="txtdeptid" runat="server" CssClass="txt_box"></asp:TextBox>
            	 </p>--%>
                <p><label>enter department name:</label><asp:TextBox ID="txtdeptname" runat="server" CssClass="txt_box"></asp:TextBox></p>
