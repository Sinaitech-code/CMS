<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.projects.Masterpages_add_project_levels"  EnableEventValidation ="true" Codebehind="add_project_levels.aspx.cs" %>
...
<head runat="server">
    <title>Add project levels</title>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">add project level</div>
            </div>
            ...
            <div id="form">
              ...
              <p>
                <label><asp:label id="Label7" runat="server"  Text="*"  ForeColor="red"></asp:label>select project:</label>
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="select project" ControlToValidate="ddlprojects"></asp:RequiredFieldValidator>
              </p>
              <p>
                <label><asp:label id="Label1" runat="server"  Text="*"  ForeColor="red"></asp:label>select sub project:</label>
                 <asp:DropDownList ID="ddlsubproject" runat="server" CssClass="dropdown" AutoPostBack="True">
                    </asp:DropDownList>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="select sub project" ControlToValidate="ddlsubproject"></asp:RequiredFieldValidator>
              </p>
                <p>
              <label><asp:label id="Label2" runat="server"  Text="*"  ForeColor="red"></asp:label>enter project level name:</label> 
                    <asp:TextBox ID="txtprojectlevel" runat="server" CssClass="txt_box"></asp:TextBox>
                     <asp:Label ID="lblcheck" runat="server" Visible="False" CssClass ="errmsg" ></asp:Label>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="enter project level name" ControlToValidate="txtprojectlevel"></asp:RequiredFieldValidator>
                    </p>
