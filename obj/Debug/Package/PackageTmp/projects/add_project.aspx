<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.projects.admin1_add_project" Codebehind="add_project.aspx.cs" %>
...
<body>
<form id="form9" runat="server" method="post">
...
<div id="main_container">
    ...
    <div id="content_holder">
            ...
            <div id="form">
                ...
                <p>
                  <label><asp:label id="Label7" runat="server"  Text="*"  ForeColor="red"></asp:label>select client:</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="select client name" ControlToValidate="ddlclient"></asp:RequiredFieldValidator>
              </p>
              <p>
                <label><asp:label id="Label1" runat="server"  Text="*"  ForeColor="red"></asp:label>select project type:</label>
              
                <asp:DropDownList ID="ddlprojtype" runat="server" CssClass="dropdown" AutoPostBack="True">
                   </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="select project type" ControlToValidate="ddlprojtype"></asp:RequiredFieldValidator>
                    
              </p>
                <p>
              <label><asp:label id="Label2" runat="server"  Text="*"  ForeColor="red"></asp:label>enter project name:</label> <%--<input name="textfield" type="text" class="txt_box" id="txtprojname" runat="server" />--%>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="enter project name" ControlToValidate="txtprojname"></asp:RequiredFieldValidator>
              </p>
                <p>
      ...
      <img src="../imgs/icon_calendar.jpg" border="0" alt=""/></a></p>
                <p>
