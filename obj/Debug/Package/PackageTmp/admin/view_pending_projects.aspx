<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_pending_projects" Codebehind="view_pending_projects.aspx.cs" %>
...
<head runat="server">
    <title>View pending projects</title>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view pending projects</div>
