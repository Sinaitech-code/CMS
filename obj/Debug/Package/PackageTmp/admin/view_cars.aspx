<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_cars" Codebehind="view_cars.aspx.cs" %>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view cars</div>
            </div>
          ...
          <td>
              ...
              <asp:GridView ID="GridView1" runat="server" CssClass="grid_content_1" width="100%" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="pageindexchanging"   >
              <Columns>
              <asp:BoundField  HeaderText="client name" DataField="client_id">
                   <HeaderStyle CssClass="grid_head" />
                  
              </asp:BoundField>
              <asp:BoundField  HeaderText="Project Name" DataField="project_id">
                  <ControlStyle CssClass="grid_head" />
                  <HeaderStyle CssClass="grid_head" />
              </asp:BoundField>
              <asp:BoundField  HeaderText=" car send by" DataField="user_id">
                  <ControlStyle CssClass="grid_head" />
                  <HeaderStyle CssClass="grid_head" />
              </asp:BoundField>
               <asp:BoundField  HeaderText=" task created date " DataField="car_send_date">
                  <ControlStyle CssClass="grid_head" />
                  <HeaderStyle CssClass="grid_head" />
              </asp:BoundField>
               
            <asp:HyperLinkField  Text="view" DataNavigateUrlFields ="car_id"  HeaderText="Manage" DataNavigateUrlFormatString ='view_car_details.aspx?car_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
              </Columns>
