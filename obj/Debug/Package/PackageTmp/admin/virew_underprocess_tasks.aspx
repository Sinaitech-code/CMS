<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_virew_underprocess_tasks" Codebehind="virew_underprocess_tasks.aspx.cs" %>
...
<head runat="server">
    <title>View underprocess tasks</title>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view underprocess tasks</div>
            </div>
         ...
         <Columns>
            ...
            <asp:HyperLinkField  Text="view" DataNavigateUrlFields ="task_id"  HeaderText="Manage" DataNavigateUrlFormatString ='view_underprocess_task_details.aspx?task_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
              </Columns>
