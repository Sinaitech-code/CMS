<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.Masterpages_add_emp_grade" Codebehind="add_emp_grade.aspx.cs" %>
...
<head runat="server">
    <title>Add employee grade</title>
...
<a id="A1" href="../Default.aspx" class="logout" runat="server">logout</a>    </div>
    <!-- end #header_bg -->
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">add emp grade</div>
          </div>
           ...
           <div id="form">
                     ...
                     <p>
                  <label><asp:label id="Label7" runat="server"  Text="*"  ForeColor="red"></asp:label>enter grade:</label>
