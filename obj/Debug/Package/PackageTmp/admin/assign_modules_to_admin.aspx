<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_assign_modules_to_admin" Codebehind="assign_modules_to_admin.aspx.cs" %>

<%@ Register Src="~/AdminHeader.ascx" TagName="AdminHeader" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Assign odules to admin</title>
       ...
       <uc1:AdminHeader ID="AdminHeader1" runat="server" />
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">assign modules to admin</div>
            </div>
            
            <div id="form">
            	<p><label>select employee Name:</label> 
                    <asp:DropDownList ID="ddladmins" runat="server" CssClass="dropdown" AutoPostBack="True">
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="select employee name" ControlToValidate="ddladmins"></asp:RequiredFieldValidator>
              </p><label>select module:</label>
              <asp:CheckBoxList ID="listmodules" runat="server"   CssClass="listbox">
                </asp:CheckBoxList>
                <p><label>&nbsp;</label> 
