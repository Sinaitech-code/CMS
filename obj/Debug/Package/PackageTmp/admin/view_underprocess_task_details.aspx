<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_underprocess_task_details" Codebehind="view_underprocess_task_details.aspx.cs" %>
...
<head runat="server">
    <title>View underprocess task details</title>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view underprocess task details</div>
            </div>
          ...
          <div id="form">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td class="grid_content_1" style="height: 27px"> <asp:Label ID="lblprojname" runat="server" Text="" >  </asp:Label>
              </td>
              </tr>
              <tr>
              ...
              <tr>
                <td width="184" class="grid_content_2">assign to:</td>
                <td width="574" class="grid_content_2"> 
                <asp:Label ID="lblassignto" runat="server" Text="" ></asp:Label></td>
              </tr>
              <tr>
                <td width="184" class="grid_content_2">assign from :</td>
                <td width="574" class="grid_content_2"> 
                <asp:Label ID="lblassignfrom" runat="server" Text="" ></asp:Label></td>
              </tr>
              <tr>
                <td class="grid_content_1">priority:</td>
                <td class="grid_content_1"> <asp:Label ID="lblpriority" runat="server" Text="" ></asp:Label>
               </td>
              </tr>
              <tr>
