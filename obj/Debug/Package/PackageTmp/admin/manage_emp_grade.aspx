<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_manage_emp_grade" Codebehind="manage_emp_grade.aspx.cs" %>
...
<head id="Head1" runat="server">
    <title>Manage employee grade</title>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">manage employee grade</div>
          </div>
