<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_purchase_requisition" Codebehind="view purchase_requisition.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>View purchase requisition</title>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view purchase requisition</div>
            </div>
          ...
          <div id="form">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td valign="top" class="grid_content_indent_1" >
                    ...
                    <asp:GridView ID="GridView1" runat="server" Width ="100%" AutoGenerateColumns ="false" CssClass="grid_content_1" AllowPaging="True" OnPageIndexChanging="grid_paging"  DataKeyNames="requisition_id">
                   <Columns >
                   ...
                   <asp:BoundField HeaderText ="employee name" DataField ="user_id" >
                    ...
                    <asp:BoundField HeaderText ="Requisition expected date" DataField ="requisition_expected_date" >
                     ...
                     <asp:HyperLinkField  Text ="view"  DataNavigateUrlFields ="requisition_id" DataNavigateUrlFormatString ='view_purchase_requisition_details.aspx?requisition_id={0}' HeaderText ="view" >
                         <HeaderStyle CssClass="grid_head" />
                     </asp:HyperLinkField>
