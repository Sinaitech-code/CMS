<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_prettyexpences_details" Codebehind="view_prettyexpences_details.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>View pretty expences details</title>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view expenses details</div>
            </div>
            created by:&nbsp;&nbsp;<asp:Label ID="lbluserid" runat="server" Text="Label"></asp:Label>&nbsp;&nbsp;
