<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_task_status_details" Codebehind="view_task_status_details.aspx.cs" %>
...
<head id="Head1" runat="server">
    <title>View task status details</title>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view task status details</div>
            </div>
          ...
          <div id="form">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="grid_content_2" >description:</td>
                <td class="grid_content_2"> <asp:Label ID="lbldesc" runat="server" Text="" ></asp:Label> </td>
              </tr>
              <tr>
                <td class="grid_content_1">
                    progress:</td>
                <td class="grid_content_1"><asp:Label ID="lblstatus" runat="server" Text=""></asp:Label>
