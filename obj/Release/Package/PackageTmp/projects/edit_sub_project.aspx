<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.projects.Projects_edit_sub_project" Codebehind="edit_sub_project.aspx.cs" %>
...
<title>Edit sub project</title>
<link href="includes/css/styles.css" type="text/css" rel="stylesheet" />
</head>

<body>
<form id="form10" runat ="server"  method ="Post">
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">edit sub project</div>
            </div>
      ...
      <img src="../imgs/icon_calendar.jpg" border="0"></a></p>
                <p>
                  <label>edit expecting to finish by:</label>
                   ...
                   <a href="javascript:;" onclick="window.open('../calnder.aspx?textbox=txtendingdate','cal','width=210,height=190,left=220,top=180')">
      <img src="../imgs/icon_calendar.jpg" border="0"></a></p>
