<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.purchases_view_purchase_requisition" Debug ="true"  Codebehind="view_purchase_requisition.aspx.cs" %>
            ...
            <%--	<h6>EMP NAME:
            	...
            	<%--<span class="form_no">Form no:
                   ...
                   <%--<span class="form_date">Form date:<asp:Label
                        ID="lblorderdate" runat="server" ></asp:Label></span>--%>
