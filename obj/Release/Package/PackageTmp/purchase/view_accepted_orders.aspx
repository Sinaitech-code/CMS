<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.purchases_view_accepted_orders" Codebehind="view_accepted_orders.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view accepted orders</div>
            </div>
              ...
              <tr>
                <td valign="top" class="grid_content_indent_1"  colspan="2"  >
                 <asp:GridView ID="GridView1" runat="server" Width ="100%" AutoGenerateColumns ="false" CssClass="grid_content_1" AllowPaging="True" OnPageIndexChanging="grid_paging"   >
                  ...
                  <asp:HyperLinkField  Text ="view"  DataNavigateUrlFields ="requisition_id" DataNavigateUrlFormatString ='purchase_order.aspx?requisition_id={0}' HeaderText ="view" >
                   <HeaderStyle CssClass="grid_head" />
                  </asp:HyperLinkField>
                   </Columns>
