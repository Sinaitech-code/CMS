<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.purchase_view_rejected_order_details" Codebehind="view_rejected_order_details.aspx.cs" %>
...
<head runat="server">
    <title>View rejected order details</title>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view rejected order details</div>
            </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
              <td valign="top" class="grid_content_indent_1"  Width ="100%">
               <asp:GridView ID="GridView1" runat="server" Width ="100%" AutoGenerateColumns ="false" CssClass="grid_content_1" DataKeyNames="requisition_detail_id" AllowPaging="True" OnPageIndexChanging="grid_pagin"   >
                   <Columns >
