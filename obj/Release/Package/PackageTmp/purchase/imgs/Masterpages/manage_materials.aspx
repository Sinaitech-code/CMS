<%@ Page Language="C#" AutoEventWireup="true" Inherits="Masterpages_manage_materials" Codebehind="manage_materials.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">manage materials </div>
          </div>
            
           <div id="form">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <%-- <tr>
                <td width="653" class="grid_head" style="height: 26px">material category name</td>
                <td width="105" class="grid_head" style="height: 26px">manage</td>
              </tr>--%>
              
          <tr>
          <td>
                <asp:GridView ID="GridView1" runat="server"  width="100%" CssClass="grid_content_1" AutoGenerateColumns ="false" OnRowDeleting="gridview_rowdeleting" >
                <Columns >
                <asp:BoundField  HeaderStyle-CssClass ="grid_head" DataField ="material_name" HeaderText ="Material Name"  />
               <asp:HyperLinkField  Text="Edit" DataNavigateUrlFields ="material_id"  HeaderText="Manage" DataNavigateUrlFormatString ='edit_materials.aspx?material_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
               <%--<asp:HyperLinkField  Text="Delete" DataNavigateUrlFields ="material_id"  HeaderText="Manage" DataNavigateUrlFormatString ='edit_materials.aspx?material_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>--%>
               </Columns>
