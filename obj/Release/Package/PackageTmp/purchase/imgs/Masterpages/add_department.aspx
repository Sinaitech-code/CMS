<%@ Page Language="C#" AutoEventWireup="true" Inherits="admin1_add_department" Codebehind="add_department.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">add department</div>
            </div>
            
            <div id="form">
            	 <%--<p><label>enter department code:</label>
                     <asp:TextBox ID="txtdeptid" runat="server" CssClass="txt_box"></asp:TextBox>--%>
            	  <%--<input name="textfield" type="text" class="txt_box" id="txtdeptid" runat="server" /> </p>--%>
                <p><label>enter department name:</label>
                <asp:TextBox ID="txtdept" runat="server" CssClass="txt_box"></asp:TextBox>
                 <%--<input name="textfield" type="text" class="txt_box" id="txtdept" runat="server" />--%></p>
                 <p><label>Description:</label> <%--<input name="textfield" type="text"  class="txt_box" id="txtdescription" runat="server" />--%>
                     <asp:TextBox ID="txtdescription"  CssClass="txt_box" runat="server" TextMode="MultiLine"></asp:TextBox>
                 </p>
                ...
                <%--<input name="button" type="submit" class="btn" id="btnsubmit" value="Submit" runat="server" onserverclick="btnsubmit_ServerClick" />--%>
                </p>
                <!--
