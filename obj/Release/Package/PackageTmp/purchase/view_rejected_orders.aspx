<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.purchases_view_rejected_orders" Codebehind="view_rejected_orders.aspx.cs" %>
...
<head runat="server">
    <title>View rejected orders</title>
      ...
      <uc1:AdminHeader ID="AdminHeader1" runat="server" />  
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view rejected orders</div>
            </div>
            <%--<uc1:AdminHeader ID="AdminHeader1" runat="server" />  --%>             
          <div id="form">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td valign="top" class="grid_content_indent_1"  colspan="2"  >
                  ...
                  <asp:HyperLinkField  Text ="view"  DataNavigateUrlFields ="requisition_id" DataNavigateUrlFormatString ='view_rejected_order_details.aspx?requisition_id={0}' HeaderText ="view" >
                      <HeaderStyle CssClass="grid_head" />
                  </asp:HyperLinkField>
