<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_daily_report_expencess" Codebehind="daily_report_expencess.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Daily report expences</title>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view daily expenses</div>
          ...
          <td>
             ...
             <asp:HyperLinkField  Text="View"  DataNavigateUrlFields="report_id" HeaderText="View"   DataNavigateUrlFormatString='pretty_expencess.aspx?report_id={0}'>
                     <HeaderStyle CssClass="grid_head" />
             </asp:HyperLinkField>
              </Columns>
