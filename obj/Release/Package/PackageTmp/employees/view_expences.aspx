<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_expences" Codebehind="view_expences.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>View expences</title>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view expenses</div>
            </div>
          ...
          <td>
              ...
              <Columns>
               <asp:BoundField  HeaderText="created by" DataField="user_id">
           ...
           <asp:BoundField  HeaderText="Date" DataField="date">
            ...
            <asp:HyperLinkField  Text="view expences" DataNavigateUrlFields ="sno"  HeaderText="Manage" DataNavigateUrlFormatString ='view_prettyexpences_details.aspx?sno={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
              </Columns>
