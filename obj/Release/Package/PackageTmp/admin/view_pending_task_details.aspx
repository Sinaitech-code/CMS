<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_pending_task_details" Codebehind="view_pending_task_details.aspx.cs" %>
...
<head runat="server">
    <title>View pending task details</title>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view pending task</div>
            </div>
