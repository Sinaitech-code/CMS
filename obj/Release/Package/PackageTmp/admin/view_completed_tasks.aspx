<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_completed_tasks" Codebehind="view_completed_tasks.aspx.cs" %>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view completed tasks</div>
            </div>
          ...
          <td>
              ...
              <asp:GridView ID="GridView1" runat="server" CssClass="grid_content_1" width="100%" AutoGenerateColumns="False" AllowPaging="True"   >
              <Columns>
               <asp:BoundField  HeaderText="task title" DataField="task_title">
             ...
             <asp:BoundField  HeaderText="assign to" DataField="assign_to">
                  <ControlStyle CssClass="grid_head" />
                  <HeaderStyle CssClass="grid_head" />
              </asp:BoundField>
                <asp:BoundField  HeaderText="assign from " DataField="user_id">
                  <ControlStyle CssClass="grid_head" />
                  <HeaderStyle CssClass="grid_head" />
              </asp:BoundField>
            <asp:HyperLinkField  Text="view" DataNavigateUrlFields ="task_id"  HeaderText="Manage" DataNavigateUrlFormatString ='view_completed_task_details.aspx?task_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
              </Columns>
