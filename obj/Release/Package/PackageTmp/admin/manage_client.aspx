<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_manage_client" Codebehind="manage_client.aspx.cs" %>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">manage clients</div>
          ...
          <tr>
          <td>
                       <asp:GridView ID="GridView1" runat="server" width="100%" AutoGenerateColumns="False"  CssClass="grid_content_1" AllowPaging="True" OnPageIndexChanging="gridview_pageindex"  >
              <Columns>
             ...
             <asp:HyperLinkField  Text="Edit" HeaderText="Edit" DataNavigateUrlFields="client_id"   DataNavigateUrlFormatString='edit_client.aspx?client_id={0}' >
                 <HeaderStyle CssClass="grid_head" />
             </asp:HyperLinkField>
