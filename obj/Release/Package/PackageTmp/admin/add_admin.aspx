      ...
      <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="select employee type" ControlToValidate="ddlemp_type"></asp:RequiredFieldValidator>
       ...
       <p><label><asp:label id="Label1" runat="server"  Text="*"  ForeColor="red"></asp:label>last name:</label> 
        ...
        <asp:ListItem>M</asp:ListItem>
         ...
         <p>
         <label><asp:label id="Label13" runat="server"  Text="*"  ForeColor="red"></asp:label>date of birth:</label>
         <asp:DropDownList ID="ddldate" runat="server" >
           ...
           <asp:DropDownList ID="ddlyear" runat="server" >
            ...
            <asp:ListItem >2050</asp:ListItem>       
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server"  InitialValue="0"  ErrorMessage="select date" ControlToValidate="ddldate"></asp:RequiredFieldValidator>  
             <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" InitialValue="0" ErrorMessage="select month" ControlToValidate="ddlmonth"></asp:RequiredFieldValidator>
             <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" InitialValue="0" ErrorMessage="select year" ControlToValidate="ddlyear"></asp:RequiredFieldValidator>
            </p>
