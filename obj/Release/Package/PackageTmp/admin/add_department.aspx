<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin1_add_department" Codebehind="add_department.aspx.cs" %>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
            ...
            <div id="form">
                ...
                <p><label><asp:label id="Label7" runat="server"  Text="*"  ForeColor="red"></asp:label>enter department name:</label>
                <asp:TextBox ID="txtdept" runat="server" CssClass="txt_box"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="enter department name" ControlToValidate="txtdept"></asp:RequiredFieldValidator>
        </p>
