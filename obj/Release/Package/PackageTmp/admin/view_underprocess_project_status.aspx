<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.admin.admin_view_underprocess_project_status" Codebehind="view_underprocess_project_status.aspx.cs" %>
...
<head runat="server">
    <title>View underprocess project status</title>
       ...
       <a href="view_pending_projects.aspx" class="side_navi">view pending projects</a>
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view underprocess project status</div>
            </div>
