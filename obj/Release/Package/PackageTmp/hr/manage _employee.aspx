<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.HR.HR_manage__employee" Codebehind="manage _employee.aspx.cs" %>
    ...
    <div id="left_corner">&nbsp;</div>                
         ...
         <asp:Label ID="lblerr_msg" runat="server"  CssClass ="errmsg" Visible ="false"></asp:Label>  
          ...
          <td style="height: 138px">
             <asp:GridView ID="GridView1"   CssClass="grid_content_1" runat="server" width="100%" DataKeyNames="emp_id" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gridview_pageindex" OnRowDeleting="gridview_deleting" AutoGenerateDeleteButton="True">
              <Columns>
               <asp:HyperLinkField  Text="Edit" DataNavigateUrlFields ="emp_id"  HeaderText="Manage" DataNavigateUrlFormatString ='edit_employee.aspx?emp_id={0}'  >
