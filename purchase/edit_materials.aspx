<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.Masterpages_edit_materials" Codebehind="edit_materials.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">edit material</div>
          </div>
            ...
            <div id="form">
              ...
              <asp:TextBox ID="txtmaterialname" runat="server" CssClass ="txt_box" ></asp:TextBox></p>
              <p>
