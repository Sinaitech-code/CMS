<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.Masterpages_manage_materials" Codebehind="manage_materials.aspx.cs" %>
   ...
   <div id="main_container">
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
          ...
          <tr>
          <td>
                <asp:GridView ID="GridView1" runat="server"  width="100%" CssClass="grid_content_1" AutoGenerateColumns ="false" OnRowDeleting="gridview_rowdeleting" OnPageIndexChanging="grid_paging" AllowPaging="True" >
                <Columns >
