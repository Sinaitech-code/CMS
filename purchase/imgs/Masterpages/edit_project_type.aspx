<%@ Page Language="C#" AutoEventWireup="true" Inherits="admin1_edit_project_type" Codebehind="edit_project_type.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">edit project type</div>
            </div>
            
            <div id="form">
            	
                 <%--<p>
                  <label>enter project cde:</label>
                    <asp:TextBox ID="txtprojcode" runat="server" CssClass="txt_box" ></asp:TextBox></p>--%>
                  <%-- <input name="textfield" runat="server"  type="text" class="txt_box" id="txtprojcode" />--%>
                 <p>
                  <label>enter project type:</label> 
                  <asp:TextBox ID="txtprojtype" runat="server" CssClass="txt_box"></asp:TextBox>
                 <%-- <input name="textfield" runat="server"  type="text" class="txt_box" id="txtprojtype" />--%></p>
                   <p>
                  <label>Description:</label> <%--<input name="textfield" runat="server"  type="text" class="txt_box" id="txtdescription" />--%>
                ...
                <p><label>&nbsp;</label>
                 ...
                 <%--<input name="button" type="submit" runat="server"  class="btn" id="btnsubmit" value="Submit" onserverclick="btnsubmit_ServerClick" />--%>
                </p>
                <!--
