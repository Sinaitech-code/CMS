<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.Masterpages_add_material" Codebehind="add_material.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">add material</div>
          </div>
            
            <div id="form">
            	
                 <p>
                  <label><asp:label id="Label1" runat="server"  Text="*"  ForeColor="red"></asp:label>select material category:</label>
                  <asp:DropDownList ID="ddlmat_cat" runat="server" CssClass ="dropdown">
                  </asp:DropDownList>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="select material category" ControlToValidate="ddlmat_cat"></asp:RequiredFieldValidator>
             </p>
               <p>
               <label><asp:label id="Label7" runat="server"  Text="*"  ForeColor="red"></asp:label>enter material name</label>
               <asp:TextBox ID="txtmaterialname" runat="server" CssClass ="txt_box" ></asp:TextBox>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="enter material name" ControlToValidate="txtmaterialname"></asp:RequiredFieldValidator>
               <asp:Label ID="lblcheck" runat="server" Visible="False" CssClass ="errmsg" ></asp:Label></p>
               <p>
