<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.purchase.purchases_view_completed_orders" Codebehind="view_completed_orders.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view completed orders</div>
            </div>
          ...
          <asp:Label ID="lblerr_msg" runat="server"  CssClass ="errmsg" Visible ="false"></asp:Label>  
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td valign="top" class="grid_content_indent_1"  colspan="2" style="height: 362px"  >
                 <asp:GridView ID="GridView1" runat="server" Width ="100%" AutoGenerateColumns ="false" CssClass="grid_content_1" AllowPaging="True" OnPageIndexChanging="grid_paging"   >
                  ...
                  <asp:HyperLinkField  Text ="view"  DataNavigateUrlFields ="requisition_id" DataNavigateUrlFormatString ='view_completed_order_details.aspx?requisition_id={0}' HeaderText ="view" >
                      <HeaderStyle CssClass="grid_head" />
                  </asp:HyperLinkField>
