<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_expences_status_details" Codebehind="view_expences_status_details.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
            ...
            <asp:Label ID="lblerr_msg" runat="server"  CssClass ="errmsg" Visible="False"></asp:Label>
             <br /> expenses created by :&nbsp;<asp:Label ID="lbluserid" runat="server" Text=""></asp:Label>
         ...
         <tr><td align ="center" style="height:10px"> </td></tr>
          <tr>
                ...
                <td align ="center" >
                    &nbsp;<input name="button2" type="submit" class="btn" id="btnback" value="back"  runat ="server" onserverclick="btnback_ServerClick"  /></td> 
              </tr>
          </table>
