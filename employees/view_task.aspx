<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_task" Codebehind="view_task.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view tasks</div>
            </div>
          ...
          <td >
              ...
              <Columns>
               <asp:BoundField  HeaderText="Task Created By" DataField="user_id">
            ...
            <asp:HyperLinkField  Text="view" DataNavigateUrlFields ="task_id"  HeaderText="Manage" DataNavigateUrlFormatString ='task_details.aspx?task_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
              </Columns>
