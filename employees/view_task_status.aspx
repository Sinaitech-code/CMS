<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_task_status" Codebehind="view_task_status.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view task status</div>
            </div>
          ...
          <td >
              ...
              <Columns>
               <asp:BoundField  HeaderText="Task To" DataField="assign_to">
            ...
            <asp:HyperLinkField  Text="view" DataNavigateUrlFields ="task_id"  HeaderText="Manage" DataNavigateUrlFormatString ='view_task_status_details.aspx?task_id={0}'  >
                   <HeaderStyle CssClass="grid_head" />
               </asp:HyperLinkField>
              </Columns>
