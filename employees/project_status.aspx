<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.project_status" Codebehind="project_status.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="4" cellpadding="0">
                  <tr>
                    <td width="24%"> <asp:label id="Label1" runat="server"  Text="*"  ForeColor="red"></asp:label>select project:</td>
                    <td width="76%">
                        <asp:DropDownList ID="ddlprojectname" runat="server" CssClass="dropdown" OnSelectedIndexChanged="ddlprojectname_SelectedIndexChanged">
                        </asp:DropDownList><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate ="ddlprojectname"
                            ErrorMessage="select project"></asp:RequiredFieldValidator>
                                          </td>
                  </tr>
                   <tr>
                    <td width="24%"> sub project:</td>
                    <td width="76%">
                        <asp:DropDownList ID="ddlsubproject" runat="server" CssClass="dropdown">
                        </asp:DropDownList>                  </td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
              ...
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td class="grid_content_1"> <asp:Label ID="lblprojectname" runat="server" Text="Label"></asp:Label></td>
                  </tr>
                   </table></td>
              </tr>
                <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
             <tr>
             <td>
              <asp:GridView ID="GridView1" runat="server" CssClass="grid_content_1" width="100%"  DataKeyNames="level_id" AutoGenerateColumns="False" AllowPaging="True"   >
              <Columns >
             <asp:BoundField  HeaderText ="Levels" DataField ="level_name" />
            <asp:TemplateField HeaderText =" Status">
            <ItemTemplate >
                <%--<asp:RadioButtonList ID="rblist1" runat="server" DataSource ='<%# rblistbind() %>' DataTextField ="status_name" DataValueField ="status_id">--%>
           ...
           <tr>
             <td><table width="100%" border="0" cellspacing="4" cellpadding="0">
              <tr>
               <td width="24%">&nbsp;</td>
               <td width="76%">
                <asp:Button ID="btnsubmit" runat="server" Text="submit project status" CssClass="btn" OnClick="btnsubmit_Click" /></td>
               </tr>
               </table></td>
              </tr>
            </table>
