<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.Employees.Employees_view_orders" Codebehind="view_orders.aspx.cs" %>
    ...
    <div id="content_holder">
        ...
        <div id="form_area">
        	<div id="form_head">
                ...
                <div id="form_head_text_area">view orders</div>
            </div>
                ...
                <td valign="top" class="grid_content_indent_1"  colspan="2"  >
                 <asp:GridView ID="GridView1" runat="server" Width ="100%" AutoGenerateColumns ="false" CssClass="grid_content_1" AllowPaging="True" OnPageIndexChanging="grid_paging"   >
                  ...
                  <asp:BoundField HeaderText ="Employee Name" DataField ="user_id"  >
                    ...
                    <asp:BoundField HeaderText ="date" DataField ="order_date"  >
                        <HeaderStyle CssClass="grid_head" />
                    </asp:BoundField>
                    
                  <asp:HyperLinkField  Text ="view"  DataNavigateUrlFields ="order_id" DataNavigateUrlFormatString ='goods_recepit_note.aspx?order_id={0}' HeaderText ="view" >
                      <HeaderStyle CssClass="grid_head" />
                  </asp:HyperLinkField>
                   </Columns>
