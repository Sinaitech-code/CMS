<%@ Page Language="C#" AutoEventWireup="True" Inherits="CMS.HR.HR_update_password" Codebehind="update_password.aspx.cs" %>
        ...
        <div id="form_area">
            ...
            <div id="form">
               ...
               <asp:Button ID="btnsave" runat="server" Text="save" CssClass="btn" OnClick="btnsave_Click" />&nbsp;
                    <asp:HyperLink ID="hback" runat="server" NavigateUrl ="../HR/reset_ password.aspx">back</asp:HyperLink>
