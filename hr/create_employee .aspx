            ...
            <div id="form">
              ...
              <p>
                ...
                <asp:ListItem >31</asp:ListItem>
                  ...
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ErrorMessage="enter date" ControlToValidate="ddldate"></asp:RequiredFieldValidator>      
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="enter month" ControlToValidate="ddlmonth"></asp:RequiredFieldValidator>      
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="enter year" ControlToValidate="ddlyear"></asp:RequiredFieldValidator>      
              </p>
